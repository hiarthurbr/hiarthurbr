...
export default function TermoQuatro(props: ReturnType<typeof getStaticProps>["props"]) {
  return <Termo
...
export function getStaticProps() {
  ...
  return {
    props: {
      ...
      final_word: [final_word.pop()!, final_word.pop()!, final_word.pop()!, final_word.pop()!] satisfies [string, ...string[]],
    },
    revalidate: 43200,
  }
}