  ...
  return (
    <div className="select-none flex flex-col justify-center items-center w-full">
      ...
      <div className="min-h-full flex flex-col items-center justify-center gap-16">
        ...
        >
          <span className="w-14 py-2 aspect-1 dark:bg-zinc-700 bg-zinc-400 text-white font-bold text-3xl text-center uppercase rounded-lg flex flex-row items-center justify-center">
            <DuckEmoji className="w-10 h-10" />
          </span>
